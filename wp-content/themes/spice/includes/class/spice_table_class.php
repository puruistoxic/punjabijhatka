...
class TT_Example_List_Table extends WP_List_Table {
    ...
    function column_title($item){
        ...
        //Build row actions
        $actions = array(
            //'edit'      => sprintf('<a href="?page=%s&action=%s&voucher=%s">Edit</a>',$_REQUEST['page'],'edit',$item['ID']),
            'delete'    => sprintf('<a href="?page=%s&action=%s&booking=%s">Delete</a>',$_REQUEST['page'],'trash',$item['ID']),
        );
    ...
    function get_sortable_columns() {
        $sortable_columns = array(
            ...
            'booking_date_time'    => array('booking_date_time',false),
            'booked_on'  => array('booked_on',false)
        );
    ...
    function prepare_items() {
         ...
         */
        $data = $this->sampledata;//$sample_data;//$this->example_data;
