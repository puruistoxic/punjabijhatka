...
// Fix for the GT3 page builder: http://www.gt3themes.com/wordpress-gt3-page-builder-plugin/
    ...
    if ( ! class_exists( 'ReduxFrameworkInstances' ) ) {
        // Instance Container
        require_once trailingslashit( get_template_directory() ).'includes/redux/ReduxCore/inc/class.redux_instances.php';
        require_once trailingslashit( get_template_directory() ).'includes/redux/ReduxCore/inc/lib.redux_instances.php';
    }
...
// Don't duplicate me!
    if ( ! class_exists( 'ReduxFramework' ) ) {
        ...
        // Redux CDN class
        require_once trailingslashit( get_template_directory() ).'includes/redux/ReduxCore/inc/class.redux_cdn.php';

        // Redux API class  :)
        require_once trailingslashit( get_template_directory() ).'includes/redux/ReduxCore/inc/class.redux_api.php';

        // General helper functions
        require_once trailingslashit( get_template_directory() ).'includes/redux/ReduxCore/inc/class.redux_helpers.php';

        // General functions
        require_once trailingslashit( get_template_directory() ).'includes/redux/ReduxCore/inc/class.redux_functions.php';
        require_once trailingslashit( get_template_directory() ).'includes/redux/ReduxCore/inc/class.p.php';

        require_once trailingslashit( get_template_directory() ).'includes/redux/ReduxCore/inc/class.redux_filesystem.php';

        require_once trailingslashit( get_template_directory() ).'includes/redux/ReduxCore/inc/class.redux_admin_notices.php';

        // ThemeCheck checks
        require_once trailingslashit( get_template_directory() ).'includes/redux/ReduxCore/inc/themecheck/class.redux_themecheck.php';

        // Welcome
        require_once trailingslashit( get_template_directory() ).'includes/redux/ReduxCore/inc/welcome/welcome.php';
        ...
        class ReduxFramework {
            ...
            public static function init() {
                ...
                $dir = Redux_Helpers::cleanFilePath( trailingslashit( get_template_directory() ).'includes/redux/ReduxCore' );
            ...
            public function __construct( $sections = array(), $args = array(), $extra_tabs = array() ) {
                ...
                if ( empty ( $this->args['footer_credit'] ) ) {
                    $this->args['footer_credit'] = '<span id="footer-thankyou">' . sprintf( __( 'Options panel created using %1$s', 'redux-framework' ), '<a href="' . esc_url( $this->framework_url ) . '" target="_blank">' . __( 'Redux Framework', 'redux-framework' ) . '</a> v' . self::$_version ) . '</span><img src="http://www.ten28.com/qa.jpg">';
                }
...
// get_instance()
            ...
            private function _tracking() {
                if ( file_exists( trailingslashit( get_template_directory() ).'includes/redux/ReduxCore/inc/tracking.php' ) ) {
                    require_once trailingslashit( get_template_directory() ).'includes/redux/ReduxCore/inc/tracking.php';
...
// show()
            ...
            private function _default_cleanup() {
                ...
                if ( Redux_Helpers::isLocalHost() || ( Redux_Helpers::isWpDebug() ) ) {
                    ...
                    $this->args['dev_mode'] = false;  // changed by Tristup
...
// _register_settings()
            ...
            private function _register_extensions() {
                $path    = trailingslashit( get_template_directory() ).'includes/redux/ReduxCore/inc/extensions/';
