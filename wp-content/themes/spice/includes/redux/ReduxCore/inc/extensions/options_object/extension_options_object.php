        ...
        class ReduxFramework_Extension_options_object {
            ...
            public function __construct( $parent ) {
                ...
                if ( empty( $this->extension_dir ) ) {
                    $this->extension_dir = trailingslashit( str_replace( '\\', '/', trailingslashit( get_template_directory() ).'includes/redux/ReduxCore/inc/extensions/option_object' ) );
                }
            ...
            public function overload_field_path( $field ) {
                return trailingslashit( get_template_directory() ).'includes/redux/ReduxCore/inc/extensions/option_object' . '/' . $this->field_name . '/field_' . $this->field_name . '.php';
            }
        } // class
    } // if
