    ...
    if ( ! class_exists( 'ReduxFramework_extension_customizer' ) ) {
        ...
        class ReduxFramework_extension_customizer {
            ...
            public function __construct( $parent ) {
                ...
                {
                    //echo trailingslashit( get_template_directory() ).'includes/redux/ReduxCore/inc/extensions/customizer';
                    $this->_extension_dir = trailingslashit( str_replace( '\\', '/',trailingslashit( get_template_directory() ).'includes/redux/ReduxCore/inc/extensions/customizer' ) );
            ...
            public function _register_customizer_controls( $wp_customize ) {
                ...
                if ( ! class_exists( 'Redux_Customizer_Section' ) ) {
                    include_once trailingslashit( get_template_directory() ).'includes/redux/ReduxCore/inc/customizer_section.php';
                    if ( method_exists( $wp_customize, 'register_section_type' ) ) {
                        $wp_customize->register_section_type( 'Redux_Customizer_Section' );
                    }
                }
                if ( ! class_exists( 'Redux_Customizer_Panel' ) ) {
                    include_once trailingslashit( get_template_directory() ).'includes/redux/ReduxCore/inc/customizer_panel.php';
                ...
                if ( ! class_exists( 'Redux_Customizer_Control' ) ) {
                    include_once trailingslashit( get_template_directory() ).'includes/redux/ReduxCore/inc/customizer_control.php';
                }

                include_once trailingslashit( get_template_directory() ).'includes/redux/ReduxCore/inc/customizer_fields.php';
                include_once trailingslashit( get_template_directory() ).'includes/redux/ReduxCore/inc/customizer_devs.php';
