        ...
        class ReduxFramework_extension_import_export {
            ...
            public function __construct( $parent ) {
                ...
                if ( empty( $this->extension_dir ) ) {
                    $this->extension_dir = trailingslashit( str_replace( '\\', '/', trailingslashit( get_template_directory() ).'includes/redux/ReduxCore/inc/extensions/import_export' ) );
                }
            ...
            public function overload_field_path( $field ) {
                return trailingslashit( get_template_directory() ).'includes/redux/ReduxCore/inc/extensions/import_export'. '/' . $this->field_name . '/field_' . $this->field_name . '.php';
            }
