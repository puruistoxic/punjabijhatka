    ...
    class Redux_Full_Package implements themecheck {
        ...
        function check( $php_files, $css_files, $other_files ) {
            ...
            if ( $redux ) {
                ...
                $blacklist = array(
                    '.tx'                    => __( 'Redux localization utilities', 'SPICE' ),
                    'bin'                    => __( 'Redux Resting Diles', 'SPICE' ),
                    'codestyles'             => __( 'Redux Code Styles', 'SPICE' ),
                    'tests'                  => __( 'Redux Unit Testing', 'SPICE' ),
                    'class.redux-plugin.php' => __( 'Redux Plugin File', 'SPICE' ),
                    'bootstrap_tests.php'    => __( 'Redux Boostrap Tests', 'SPICE' ),
                    '.travis.yml'            => __( 'CI Testing FIle', 'SPICE' ),
                    'phpunit.xml'            => __( 'PHP Unit Testing', 'SPICE' ),
                );
