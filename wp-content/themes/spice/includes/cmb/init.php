	...
	class CMB2_Bootstrap_208 {
		...
		public function include_cmb() {
			...
			if ( ! defined( 'CMB2_DIR' ) )
			{
				...
				define( 'CMB2_DIR', trailingslashit( get_template_directory() ).'includes/cmb/' );
			}
		...
		public function l10ni18n() {
			...
			if ( ! $loaded ) {
				...
				$mofile = trailingslashit( get_template_directory() ).'includes/cmb'. '/languages/cmb2-' . $locale . '.mo';
