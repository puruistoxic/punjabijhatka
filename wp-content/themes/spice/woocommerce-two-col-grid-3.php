...
?>
<div class="row shop-layout-two-col">
			<section class="shop-left <?php printf(__('%s','SPICE'),esc_attr($col_class)) ?> <?php printf(__('%s','SPICE'),esc_attr($sidebar_class)); ?> product-grid-3">			  		  
						<?php
