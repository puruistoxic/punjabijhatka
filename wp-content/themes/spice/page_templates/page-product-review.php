<?php
		...
		*/
		...
		$no_of_reviews=get_post_meta($post_id,'spice_home_review_style2_no',true);
		$home_page_icon=get_post_meta($post_id,'spice_home_review_style2_page_icon',true);
		...
		<div id="page-<?php echo get_the_ID(); ?>" class="static-overlay" <?php echo esc_attr($data_steller); ?>></div>
				<section class="user-reviews">
					<div class="container">
					    <?php if(!empty($home_page_icon)){?><img src="<?php printf('%s',esc_html($home_page_icon)); ?>" alt=""><?php } ?>						
						...
						<div class="review-wrapper">
							<?php								
									...
									$args = array ('post_type' => 'product','number'=>$no_of_reviews);
									$comments = get_comments( $args );				
									wp_list_comments( array( 'callback' => 'spice_woocommerce_comments' ), $comments);
