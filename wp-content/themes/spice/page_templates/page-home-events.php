<?php
		/*
		Template Name: Home Page Events
		*/
		...
		$no_of_events=get_post_meta($post_id,'spice_home_event_no',true);
		$home_page_icon=get_post_meta($post_id,'spice_home_event_page_icon',true);
		...
		<div id="page-<?php echo get_the_ID(); ?>" class="static-overlay" <?php echo esc_attr($data_steller); ?>></div>
			<section class="everyday-events">
					<div class="container">
						...
						?>
									<div class="feature-events-wrapper event-<?php printf(__('%s','SPICE'),get_the_ID()) ?>">
											...
											<div class="figcaption event">
												...
												<div class="corner-details">
													...
													<div class="corner-time"><i class="fa fa-clock-o"></i>
														<?php printf('%s - %s',esc_html($start_time),esc_html($end_time)); ?>
													</div>
												</div>
						...
						<a href="javascript:void(0);" data-page="<?php echo esc_attr($post_id); ?>" class="button white-btn load-more-event" data-item="2"><?php  esc_html_e('LOAD MORE','SPICE'); ?></a>
						<div id="testdata">
