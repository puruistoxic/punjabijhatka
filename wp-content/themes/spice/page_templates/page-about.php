<?php
		...
		*/
		...
		$content_title=get_post_meta($post_id,'spice_about_content_title',true);
		$content_subtitle=get_post_meta($post_id,'spice_about_content_subtitle',true);
		$about_title_logo=get_post_meta($post_id,'spice_about_title_logo',true);
		$about_title_image=get_post_meta($post_id,'spice_about_title_image',true);
						...
						<article class="content-wrapper">
							<div class="clearfix">
								...
								<?php
									...
									{
								?>
									<img src="<?php printf('%s',esc_url(spice_getLogo())); ?>" alt="">
								<?php
									}
								?>
									<h2 class="page-title-<?php echo get_the_ID(); ?>"><?php printf(__('%s','SPICE'),esc_html($content_title)); ?></h2>
									<h4 class="page-sub-title-<?php echo get_the_ID(); ?>"><?php printf(__('%s','SPICE'),esc_html($content_subtitle)); ?></h4>
								</div>
								<?php
									if(!empty($about_title_image))
									{
								?>
								
								<div class="about-img-holder">
									<img src="<?php printf(__('%s','SPICE'),esc_url($about_title_image)); ?>" alt="">
								</div>
								<?php
									}
								?>
