...
if ( ! class_exists( 'TM_Facebook_Page_Widget' ) ) {
	class TM_Facebook_Page_Widget extends Insight_Widget {
		...
		public function __construct() {
			...
			$this->widget_description = esc_html__( 'Adds support for Facebook Page Plugin.', 'tm-arden' );
			$this->widget_id          = 'facebook-like-widget';
			$this->widget_name        = esc_html__( '[Insight] Facebook Page Plugin', 'tm-arden' );
			$this->settings           = array(
				'title'        => array(
					'type'  => 'text',
					'std'   => esc_html__( 'Find us on Facebook', 'tm-arden' ),
					'label' => esc_html__( 'Title', 'tm-arden' ),
				),
				'page_url'     => array(
					'type'  => 'text',
					'std'   => '',
					'label' => esc_html__( 'Facebook Page Url', 'tm-arden' ),
				),
				'app_id'       => array(
					'type'  => 'text',
					'std'   => '',
					'label' => esc_html__( 'Facebook App ID', 'tm-arden' ),
					'desc'  => sprintf( wp_kses( __( 'IMPORTANT: Please create a Facebook App and use its ID for features like sharing. <a href="%s" target="_blank">See Instructions</a>', 'tm-arden' ), array(
						'a' => array(
							'href'   => array(),
							'target' => array(),
						),
				...
				'width'        => array(
					...
					'max'   => 500,
					'std'   => 268,
					'label' => esc_html__( 'Width (has to be between 180 and 500)', 'tm-arden' ),
				),
				'show_faces'   => array(
					'type'  => 'checkbox',
					'std'   => 1,
					'label' => esc_html__( 'Show Friends Faces', 'tm-arden' ),
				),
				'show_stream'  => array(
					'type'  => 'checkbox',
					'std'   => 0,
					'label' => esc_html__( 'Show Posts', 'tm-arden' ),
				),
				'show_header'  => array(
					'type'  => 'checkbox',
					'std'   => 0,
					'label' => esc_html__( 'Show Cover Photo', 'tm-arden' ),
				),
				'small_header' => array(
					'type'  => 'checkbox',
					'std'   => 0,
					'label' => esc_html__( 'Use Small Header', 'tm-arden' ),
				),
			);
