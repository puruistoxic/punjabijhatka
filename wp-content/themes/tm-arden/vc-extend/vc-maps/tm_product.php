...
vc_map( array(
	        'name'     => esc_html__( 'Product', 'tm-arden' ),
	        'base'     => 'tm_product',
	        'category' => INSIGHT_VC_SHORTCODE_CATEGORY,
	        'icon'     => 'tm-i tm-i-product',
	        'params'   => array_merge( array(
		                                   array(
			                                   'heading'     => esc_html__( 'Product Style', 'tm-arden' ),
			                                   'type'        => 'dropdown',
			                                   'param_name'  => 'style',
			                                   'admin_label' => true,
			                                   'value'       => array(
				                                   esc_html__( 'Grid Classic', 'tm-arden' )    => '1',
				                                   esc_html__( 'Carousel Slider', 'tm-arden' ) => '2',
			                                   ),
			                                   'std'         => '1',
		                                   ),
		                                   array(
			                                   ...
			                                   'value'       => array(
				                                   ...
				                                   esc_html__( '560x720', 'tm-arden' ) => 'insight-product-grid-classic',
			                                   ),
