...
if ( ! class_exists( 'ThemeMove_Number_Responsive' ) ) {
	class ThemeMove_Number_Responsive {
		...
		public function render() {
			...
			$sizes = array(
				'lg' => esc_html__( 'Large', 'tm-arden' ),
				'md' => esc_html__( 'Medium', 'tm-arden' ),
				'sm' => esc_html__( 'Small', 'tm-arden' ),
				'xs' => esc_html__( 'Extra small', 'tm-arden' ),
			);
		...
		public function media_query_input( $icon, $tooltip, $key, $min, $max, $step ) {
			...
			$html .= '<label for="' . $key . '" class="hint--top hint-bounce" data-hint="' . esc_attr( $tooltip ) . '">' . $icon . "</label>";
