...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<h2><?php esc_html_e( 'Calculate Shipping', 'tm-arden' ); ?></h2>
	...
	<section class="shipping-calculator-form" style="display:none;">
		...
		<?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_country', true ) ) : ?>
			<p class="form-row form-row-wide" id="calc_shipping_country_field">
				<select name="calc_shipping_country" id="calc_shipping_country" class="country_to_state"
					...
					<option value=""><?php esc_html_e( 'Select a country&hellip;', 'tm-arden' ); ?></option>
					<?php
			...
			<div id="calc_shipping_state_field">
				...
				if ( is_array( $states ) && empty( $states ) ) {
					...
					<input type="hidden" name="calc_shipping_state" id="calc_shipping_state"
					       placeholder="<?php esc_attr_e( 'State / county', 'tm-arden' ); ?>"/>
					<?php
					...
					<p class="form-row form-row-wide">
						<span>
							<select name="calc_shipping_state" id="calc_shipping_state"
							        placeholder="<?php esc_attr_e( 'State / county', 'tm-arden' ); ?>">
										<option
											value=""><?php esc_html_e( 'Select a state&hellip;', 'tm-arden' ); ?></option>
								<?php
		...
		<?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_city', false ) ) : ?>
			...
			<p class="form-row form-row-wide" id="calc_shipping_city_field">
				<input type="text" class="input-text"
				       ...
				       placeholder="<?php esc_attr_e( 'City', 'tm-arden' ); ?>" name="calc_shipping_city"
		...
		<?php if ( apply_filters( 'woocommerce_shipping_calculator_enable_postcode', true ) ) : ?>
			...
			<p class="form-row form-row-wide" id="calc_shipping_postcode_field">
				<input type="text" class="input-text"
				       ...
				       placeholder="<?php esc_attr_e( 'Postcode / ZIP', 'tm-arden' ); ?>"
		...
		<p>
			<button type="submit" name="calc_shipping" value="1"
			        class="button"><?php esc_html_e( 'Update Totals', 'tm-arden' ); ?></button>
		</p>
