	...
	function( window, document, Math ) {
		...
		var utils = (
			function() {
				...
				me.prefixPointerEvent = function( pointerEvent ) {
					return window.MSPointerEvent ? 'MSPointer' + pointerEvent.charAt( 7 )
																			 .toUpperCase() + pointerEvent.substr( 8 ) : pointerEvent;
				};
		...
		function IScroll( el, options ) {
			...
			if ( ! this.options.useTransition && ! this.options.useTransform ) {
				if ( ! (
						/relative|absolute/i
					).test( this.scrollerStyle.position ) ) {
...
(
	function( $ ) {
		"use strict";
		var $body              = $( 'body' );
		var $container         = $( '#test.one-page-scroll' );
		var dots               = true;
